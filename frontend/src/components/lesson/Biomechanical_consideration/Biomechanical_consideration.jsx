...
function BiomechanicalConsideration() {
  ...
  const handleAddAnimation = async (event) => {
    ...
    Swal.fire({
      title: "กำลังอัปโหลด...",
      html: 'โปรดรอสักครู่ <b id="progress-text">0%</b>',
      didOpen: () => {
        Swal.showLoading();
      },
    ...
    try {
      await axios.post(`${baseUrl}/animation/saveAnimation`, formData, {
        headers: {
        ...
        onUploadProgress: (progressEvent) => {
          if (progressEvent.total) {
            ...
            // อัปเดตข้อความเปอร์เซนต์ใน Swal
            const progressText =
  ...
  return (
    <div className="Content">
      ...
      <div className="Content" style={{ margin: "20px" }}>
        <h1 style={{ margin: "0", fontSize: "1.5rem", marginBottom: "15px" }}>
          เพิ่มแอนิเมชัน
        </h1>
        ...
        <form onSubmit={handleAddAnimation}>
          ...
          >
            {/* ชื่อแอนิเมชัน */}
            <label htmlFor="Ani_name" className="lebel-bio">
              ชื่อแอนิเมชัน : <span style={{ color: "red" }}>*</span>
            </label>
            <br />
            <textarea
              style={{
          ...
          >
            <label htmlFor="Ani_description" className="lebel-bio">
              รายละเอียดแอนิเมชัน : <span style={{ color: "red" }}>*</span>
            </label>
            <br />
            <textarea
              style={{
          ...
          >
            <label htmlFor="Ani_animation" className="lebel-bio">
              ไฟล์แอนิเมชัน : <span style={{ color: "red" }}>* </span>
              <span
                style={{ color: "red", fontWeight: "400", fontSize: "0.85rem" }}
              ></span>
            </label>
            <br />
            <Input
              key={Ani_animation ? Ani_animation.name : "empty"}
              type="file"
              name="Ani_animation"
                ...
                >
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: "12px", color: "#444444" }}>
                      {" "}
                      {Ani_animation.size
                        ? (Ani_animation.size / (1024 * 1024)).toFixed(2) +
                          " MB"
                        : "ขนาดไฟล์ไม่ถูกต้อง"}
                    </div>
                  </div>
          ...
          >
            <label htmlFor="Ani_image" className="lebel-bio">
              ไฟล์รูปภาพหน้าปกแอนิเมชัน :{" "}
              <span style={{ color: "red" }}>*</span>
            </label>
            <br />
            <Input
              key={Ani_image ? Ani_image.name : "empty"}
              type="file"
              name="Ani_image"
              className="choose-file"
              id="Ani_image"
                ...
                >
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: "12px", color: "#444444" }}>
                      {" "}
                      {Ani_image.size
                        ? (Ani_image.size / (1024 * 1024)).toFixed(2) + " MB"
                        : "ขนาดไฟล์ไม่ถูกต้อง"}
                    </div>
                  </div>
                </div>
