...
function Edit_Biomechanical_consideration() {
  ...
  const [originalAnimationDescription, setOriginalAnimationDescription] =
    useState("");
  ...
  useEffect(() => {
    if (id) {
      axios
        ...
        .then((response) => {
          const { Ani_name, Ani_description, Ani_animation, Ani_image } =
            response.data;
  ...
  return (
    <div className="Content">
      ...
      >
        <h1 style={{ margin: "0", fontSize: "20px", marginBottom: "15px" }}>
          แก้ไขแอนิเมชัน
        </h1>
        {loading ? (
          <Button
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        {decodeURIComponent(selectedFile.name)}
                      </div>
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        {decodeURIComponent(selectedImage.name)}
                      </div>
                      <div style={{ fontSize: "12px", color: "#444444" }}>
                        {" "}
                        {selectedImage.size
